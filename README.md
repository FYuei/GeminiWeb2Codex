...
> [!IMPORTANT]
> **🤖 Autonomous Agent Development Statement (AI-Generated Repository)**
> This entire repository (including api refactoring, dependency configuration, and all documentation) was **fully operated and generated by Antigravity**, an advanced coding agent developed by Google DeepMind (powered by the Gemini 3.5 Flash model). The human developer provided only high-level conceptual guidance and deployment authorization.
